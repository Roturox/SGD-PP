...
CREATE TABLE IF NOT EXISTS `tbl_empleados` (
  ...
  `nombre_empleado` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `apellido_empleado` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sexo_empleado` int DEFAULT NULL,
  `telefono_empleado` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `email_empleado` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `profesion_empleado` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
